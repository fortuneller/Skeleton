...
export default function Project() {
     ...
     <section id="works">
          ...
          <span className="worksDesc">I take pride in paying attention to the smallest details and making dure my work is pixel perfect/ 
          i am excited to bring my skills and experience to help businesses zchieve their goals and create a strong online presence</span> 
